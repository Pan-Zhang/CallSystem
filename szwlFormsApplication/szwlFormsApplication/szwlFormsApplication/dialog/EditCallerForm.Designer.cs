namespace szwlFormsApplication.dialog
{
	partial class EditCallerForm
	{
		...
		private void InitializeComponent()
		{
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(174, 207);
			...
			this.Name = "EditCallerForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "修改呼叫器";
			this.Load += new System.EventHandler(this.EditCallerForm_Load);
